...
//Add the code for car1_up() function:
function car1_up()
{
	if (car1_y >=0) 
	{
...
//Add the code for car2_up() function:
function car2_up()
{
	if (car2_y >=0) 
	{
...
//Add the code for car1_down() function:
function car1_down()
{
	if (car1_y <=500) 
	{
...
//Add the code for car2_down() function:
function car2_down()
{
	if (car2_y <=500) 
	{
...
//Add the code for car1_left() function:
function car1_left()
{
	if (car1_x >=0) 
	{
...
//Add the code for car2_left() function:
function car2_left()
{
	if (car2_x >=0) 
	{
...
//Add the code for car1_right() function:
function car1_right()
{
	if (car1_x <=700) 
	{
...
//Add the code for car2_right() function:
function car2_right()
{
	if (car2_x <=700) 
	{
